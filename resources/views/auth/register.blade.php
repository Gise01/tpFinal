                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" placeholder= 'usuario@email.com'>
                        ...
                        <div class="form-group row">
                            <label for="suscription" class="col-md-4 col-form-label text-md-right">{{ __('Suscripción al Newsletter') }}</label>

                            <div class="col-md-6">
                                <input id="suscription" type="radio" name="suscription" value="si" autofocus checked>SI    
                                <input id="suscription" type="radio" name="suscription" value="no" autofocus>NO
                                @error('suscription')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
