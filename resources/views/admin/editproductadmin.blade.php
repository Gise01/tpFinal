                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('editarrproductoadminpost', $product->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="price" type="number" class="form-control @error('price') is-invalid @enderror" name="price" value="{{ $product->price }}" required autocomplete="price" min="0" value="0" step="any" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="description" type="textarea" class="form-control @error('description') is-invalid @enderror" name="description" value="{{ $product->description }}" autocomplete="description" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="stock" type="number" class="form-control @error('stock') is-invalid @enderror" name="stock" value="{{ $product->stock }}" required autocomplete="email" min="0" value="0" step="any">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="category" name="category_id" class="form-control @error('category') is-invalid @enderror" required autofocus>
                                    ...
                                    <option name="category_id" value="{{ $category->id }}" {{ $category->id === $product->category_id ? 'selected' : '' }}>{{ $category->name }}</option>
                                    @endforeach
                                </select>
                                @error('category')
                                    <span class="invalid-feedback" role="alert">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="brand" name="brand_id" class="form-control @error('brand') is-invalid @enderror" required autofocus>
                                    ...
                                    <option name="brand_id" value="{{ $brand->id }}" {{ $brand->id === $product->brand_id ? 'selected' : '' }}>{{ $brand->name }}</option>
                                    @endforeach
                                </select>
                                @error('brand')
                                    <span class="invalid-feedback" role="alert">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="discount" name="discount_id" class="form-control @error('discount') is-invalid @enderror" required autofocus>
                                    ...
                                    <option name="discount_id" value="{{ $discount->id }}" {{ $discount->id === $product->discount_id ? 'selected' : '' }}>{{ $discount->name }}</option>
                                    @endforeach
                                </select>
                                @error('discount')
                                    <span class="invalid-feedback" role="alert">
