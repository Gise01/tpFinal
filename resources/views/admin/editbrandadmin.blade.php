    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card text-center">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('editarmarcasadminpost', $brand->id) }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="description" type="textarea" class="form-control @error('description') is-invalid @enderror" name="description" value="{{ $brand->description }}" autocomplete="description" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div>
                                    <img id="imageBrand" src="{{ Storage::url($brand->image) }}" alt="" sizes="" srcset="">
                                </div>
